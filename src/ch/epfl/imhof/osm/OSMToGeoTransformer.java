...
public final class OSMToGeoTransformer {
    ...
    private final Set<String> AREA_VALUE = new HashSet<>(Arrays.asList("yes", "1", "true"));
    private final Set<String> AREA_ATTRIBUTS = new HashSet<>(Arrays.asList(
    ...
    private final Set<String> FILTRE_POLYLINE = new HashSet<>(Arrays.asList(
            "bridge", "highway", "layer", "man_made", "railway",
            "tunnel", "waterway"
            ));
    private final Set<String> FILTRE_POLYGON = new HashSet<>(Arrays.asList(
    ...
    private List<Attributed<Polygon>> assemblePolygon(OSMRelation relation, Attributes attributes){
        ...
        Collections.sort(outers, new Comparator<ClosedPolyLine>(){
            @Override
            public int compare(ClosedPolyLine o1, ClosedPolyLine o2) {
                return (int)(o1.area() - o2.area());    //ROMAIN!!!!! TODO!!!!>< hehe COURAGE!!
            }
        });
